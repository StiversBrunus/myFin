...
UC001 - O usuário pode criar uma Wallet.
...
## Movimentações (Investment Transaction)
...
UC017 - O usuário pode cadastrar um investimento.

UC018 - O usuário pode listar os investimento.

UC019 - O usuário pode alterar nome, descrição e status do investimento.
...
UC027 - O usuário pode consultar o saldo de um Goal.

UC028 -  O usuário pode consultar o saldo de uma Reserve.

UC029 - O usuário pode consultar o saldo de uma Wallet.
